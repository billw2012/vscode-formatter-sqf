...
if (!object_wrapper.values) {
        ...
        function tokenize_next() {
            ...
            if (c === '`' || c === "'" || c === '"' || ((c === '/') || (opts.e4x && c === "<" && input.slice(parser_pos - 1).match(startXmlRegExp))) && ((last_token.type === 'TK_RESERVED' && in_array(last_token.text, ['return', 'case', 'throw', 'else', 'do', 'typeof', 'yield'])) || (last_token.type === 'TK_END_EXPR' && last_token.text === ')' && last_token.parent && last_token.parent.type === 'TK_RESERVED' && in_array(last_token.parent.text, ['if', 'while', 'for'])) || (in_array(last_token.type, ['TK_COMMENT', 'TK_START_EXPR', 'TK_START_BLOCK', 'TK_END_BLOCK', 'TK_OPERATOR', 'TK_EQUALS', 'TK_EOF', 'TK_SEMICOLON', 'TK_COMMA'])))) {
                ...
                if (sep === '/') {
                    ...
                    var parse_string = function(delimiter, allow_unescaped_newlines=undefined, start_sub=undefined) {
                        var current_char;
    ...
    //     define([], function() {
    //         return {
    //             js_beautify2: js_beautify2
    //         };
    //     });
    // } else if (typeof exports !== "undefined") {
    //     exports.js_beautify2 = js_beautify2;
    // } else if (typeof window !== "undefined") {
    //     window.js_beautify2 = js_beautify2;
    // } else if (typeof global !== "undefined") {
    //     global.js_beautify2 = js_beautify2;
    // }
